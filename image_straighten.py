...
if __name__ == '__main__':
    # img = cv2.imread('./TestImages/plain-paper-images/val1.png',0)
    img = cv2.imread('./TestImages/line/val1.png')
    ...
    # sheared_img = cv2.dilate(sheared_img, kernel)
    ...
    cv2.imwrite('./result/data/rTest1.png', thresh)
else:
