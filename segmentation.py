...
img = cv.imread('/home/greeshma/CNN-for-character-Recogonition/Segmentation/Cursive_handwriting_recognition/TestImages/line/val3.png')
...
##------------Modified segmentation for removing circles----------------------------###            
    arr=[]
    print("Length of segment",len(seg2))
    for i in (seg2):
        arr1 = []
        j = upper_baseline
